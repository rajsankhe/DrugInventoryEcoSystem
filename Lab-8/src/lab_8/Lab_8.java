...
public class Lab_8 {
    ...
    private void runAnalysis() {
        ...
        System.out.println(PROBLEM + ++i + " 5 Most Likes Comments");
        helper.getFiveMostLikedComment();
        System.out.println(SEPERATOR);
        System.out.println(PROBLEM + ++i + " User with Most Likes on Comments");
        helper.userWithMostLikes();
        System.out.println(SEPERATOR);
        System.out.println(PROBLEM + ++i + " Average number of Likes per Comments");
        helper.averageNumOfLikesPerComment();
        System.out.println(SEPERATOR);
        System.out.println(PROBLEM + ++i + " Post with most number of Comments");
        helper.postWithMostNumComments();
        System.out.println(SEPERATOR);
        System.out.println(PROBLEM + ++i + " Posts with most liked comments");
        helper.postWithMostLikedComment();
        System.out.println(SEPERATOR);
        System.out.println(PROBLEM + ++i + " Top 5 Inactive Users based on Posts");
        helper.topFiveInactiveUserBasedOnPosts();
        System.out.println(SEPERATOR);
        System.out.println(PROBLEM + ++i + " Top 5 Inactive Users based on Comments");
        helper.topFiveInactiveUserBasedOnComments();
        System.out.println(SEPERATOR);
        System.out.println(PROBLEM + ++i + " Top 5 Inactive Users based on Posts and Comments combined");
        helper.topFiveInactiveUserOverall();
        System.out.println(SEPERATOR);
        System.out.println(PROBLEM + ++i + " Top 5 Active Users based on Posts and Comments combines");
        helper.topFiveActiveUserOverall();
    }
